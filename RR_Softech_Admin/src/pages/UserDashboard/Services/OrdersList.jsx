...
export default function OrdersList() {
  ...
  return (
    <div className="relative bg-gray-50 h-full px-3 sm:px-6 lg:px-8 py-4 sm:py-6 border border-gray-200 rounded-xl overflow-x-hidden">
      {/* Header */}
      <div className="bg-white rounded-2xl shadow-x border border-slate-200 px-4 py-4 sm:px-6 sm:py-6 mb-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-2 bg-slate-100 rounded-xl p-1.5 border border-slate-200 shadow-sm cursor-pointer">
            ...
            >
              ...
              />
              <span className="hidden sm:inline font-semibold">List View</span>
            </button>
          </div>
        </div>
      </div>
      ...
      <div
        className={
          viewMode === "grid"
            ? "w-full max-w-xl sm:max-w-3xl xl:max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-5 sm:gap-6"
            : "w-full max-w-xl sm:max-w-3xl xl:max-w-5xl mx-auto flex flex-col gap-4"
        }
      >
